...
public class UserForm extends JPanel {
    ...
    public void setAddUser(JLabel addUser) {
        this.addUserLbl = addUser;
    }
    ...
    public void setCanselUser(JLabel canselUser) {
        this.canselUserLbl = canselUser;
    }
    ...
    public void setUserNameTextArea(JTextField userNameTextArea) {
        this.userNameTextField = userNameTextArea;
    }
